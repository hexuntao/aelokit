...
import {
  getHreflangValue as getHreflangValueBase,
  generateHreflangUrls as generateHreflangUrlsBase,
  getCurrentHreflang as getCurrentHreflangBase,
  generateAlternates as generateAlternatesBase,
} from '@repo/i18n/hreflang';
...
export function getHreflangValue(locale: Locale): string {
  return getHreflangValueBase(locale, websiteConfig.i18n);
}
...
export function getCurrentHreflang(locale: Locale): string {
  return getCurrentHreflangBase(locale, websiteConfig.i18n);
}
