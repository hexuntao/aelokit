import { createMessageGetter, type MessageLoader } from '@repo/i18n/messages';
...
const importLocale: MessageLoader = async (
  locale: Locale
): Promise<Messages> => {
 ...
 */
export const getMessagesForLocale = createMessageGetter(
  importLocale,
