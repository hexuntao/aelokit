...
export default function FeaturesSection() {
  ...
  const images = {
    'item-1': {
      image: '/images/blocks/charts-light.png',
      darkImage: '/images/blocks/charts.png',
      alt: 'Product Feature One',
    },
    'item-2': {
      image: '/images/blocks/music-light.png',
      darkImage: '/images/blocks/music.png',
      alt: 'Product Feature Two',
    },
    'item-3': {
      image: '/images/blocks/mail2-light.png',
      darkImage: '/images/blocks/mail2.png',
      alt: 'Product Feature Three',
    },
    'item-4': {
      image: '/images/blocks/payments-light.png',
      darkImage: '/images/blocks/payments.png',
        ...
        <div className="grid gap-12 sm:px-12 lg:grid-cols-12 lg:gap-24 lg:px-0">
          ...
          <div className="bg-background w-full relative flex overflow-hidden rounded-2xl border p-2 lg:h-auto lg:col-span-7">
            ...
            <BorderBeam
              duration={6}
              size={200}
              className="from-transparent via-primary to-transparent dark:via-accent"
            />
          </div>
        </div>
      </div>
